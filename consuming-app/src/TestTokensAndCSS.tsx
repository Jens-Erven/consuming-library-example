...
export function TestTokensAndCSS() {
  return (
    <div style={{ padding: '20px' }}>
      ...
      <div style={{ marginTop: '20px', backgroundColor: '#f5f5f5', padding: '10px', borderRadius: '8px' }}>
        <h3>📊 Token Values:</h3>
      ...
      <div style={{ marginTop: '20px', padding: '15px', backgroundColor: '#fff3cd', borderRadius: '8px' }}>
        ...
        <ol style={{ fontSize: '14px' }}>
          <li>
            ...
            <pre style={{ backgroundColor: '#f5f5f5', padding: '5px', marginTop: '5px' }}>
              import '@jens-erven/fe-lib/css/forest/light';
            </pre>
            Then use: <code>var(--primary)</code>, <code>var(--secondary)</code>, etc.
          </li>
          <li style={{ marginTop: '10px' }}>
            ...
            Then use classes: <code>bg-primary</code>, <code>text-primary-contrast</code>, etc.
          </li>
        </ol>
      </div>
    </div>
